...
const Container = styled<"div", {}, Theme>("div", ({ $theme }) => ({
  height: "64px",
  background: `linear-gradient(to left, ${$theme.colors.black400}, ${$theme.colors.black500}, ${$theme.colors.black600}, ${$theme.colors.black700}, ${$theme.colors.black800}, ${$theme.colors.black900}, ${$theme.colors.black900})`,
  color: $theme.colors.white, // black color for text
  display: "grid",
  padding: "0 1.25rem",
        ...
        <Block $style={{ display: "flex", alignItems: "center", justifyContent: "flex-end" }}>
          ...
          <Button
            ...
            overrides={{
              BaseButton: {
                style: {
                  color: theme.colors.white, // change color to white
                  ':hover': {
                    color: theme.colors.primary700, // change color to darkish teal on hover
                  },
                },
              },
              StartEnhancer: {
